...
Add two new review stages to the xiaoming workflow:
...
**Location:** `skills/xiaoming-brainstorming-writing-plans/plan-document-reviewer-prompt.md`
...
- `skills/xiaoming-brainstorming-writing-plans/plan-document-reviewer-prompt.md`

**Modified files:**
- `skills/brainstorming/SKILL.md` - add review loop after spec written
- `skills/xiaoming-brainstorming-writing-plans/SKILL.md` - add chunk-by-chunk review loop, update task syntax examples
