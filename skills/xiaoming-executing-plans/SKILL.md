...
**注意：** 告知你的真人伙伴，小明 (Xiaoming) 在有子代理 (subagent) 访问权限时效果会好得多。如果在支持子代理的平台上运行（如 Claude Code 或 Codex），工作质量将显著提升。如果子代理可用，请使用 xiaoming:xiaoming-brainstorming-subagent-driven-development 代替此技能 (skill)。
...
- **必须使用子技能：** 使用 xiaoming:xiaoming-brainstorming-finishing-a-development-branch
