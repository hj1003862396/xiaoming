...
Execute this plan using the `xiaoming:xiaoming-brainstorming-subagent-driven-development` skill.
...
**Do:**
- Initialize `go.mod` with module name `github.com/xiaoming-test/fractals`
