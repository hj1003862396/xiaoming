...
mkdir -p src test docs/xiaoming/plans

# Create a simple implementation plan
cat > docs/xiaoming/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/xiaoming/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/xiaoming/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"xiaoming:xiaoming-brainstorming-subagent-driven-development"' "$SESSION_FILE"; then
