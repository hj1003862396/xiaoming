...
```bash
cd /Users/drewritter/prime-rad/xiaoming && node tests/brainstorm-server/server.test.js
```
...
```bash
cd /Users/drewritter/prime-rad/xiaoming && lib/brainstorm-server/start-server.sh --project-dir /tmp/brainstorm-smoke-test
```
